...
#### Analyst Observation: 
   ...
   -	Initial investigation of the suspected process `stealer.exe` identifies it was executed through Windows `Explorer.exe` `PPID=5276` with the ProcessId of 5164 which will be used for further investigation into the impact and scope of post-compromise activity.
