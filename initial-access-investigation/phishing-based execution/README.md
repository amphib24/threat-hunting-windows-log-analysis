## Initial Access Investigation - Phishing 
...
-	Further Analysis indicates the file `best-cat.jpg.exe` was created by `Explorer.ex`e within the Administrator’s Picture directory following the extraction of the download archive. The use of a double file extension `.jpg.exe` is a commonly used technique used to disguise executable files as legitimate images, which is indicative of potentially malicious activity associated with phishing campaigns.
